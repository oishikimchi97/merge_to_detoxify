...
from mtd.eval.utils import batchify, load_cache


def get_perspective_api_key(file_path):
...
PERSPECTIVE_API_KEY = get_perspective_api_key("config/api/perspective.yaml")
